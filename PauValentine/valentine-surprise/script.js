        ...
        content.innerHTML = `
            <div class="envelope-wrapper">
                <div id="envelope" class="close">
                    ...
                    <div class="letter">
                        <p class="words line1">Hi love, I'm so happy to have you in my life</p>
                        <p class="words line2">I hope that I'll be with you foreve</p>
                        <p class="words line3">I love you more than you’ll ever know!</p>
                        <p class="words line4">- Igop mong bf</p>
                    </div>
                </div>
            </div>
